package net.systemeD.potlatch2.tools
{
	...
	public class MagicRoundabout
	{
		...
		public function MagicRoundabout(initNode: Node, initRadius: Number, performAction:Function) {
			node = initNode;
			radius = initRadius;
...
/*          
            ...
            // they both work. This splits any ways that cross the central node,
            // then splits them where they hit the roundabout, then removes all the nodes
